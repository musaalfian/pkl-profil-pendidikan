          ...
          <div class="content mt20">
            <div class="d-flex justify-content-between align-items-center">
              <h3 class="fw-bold darkblue">
                <span class="me-3 fw-bold darkblue"><?= $i; ?>.</span> <?= $data['nama_jabatan']; ?> :
                <?= $data['nama_karyawan']; ?>
              </h3>
            ...
            <div class="collapse" id="extend_<?= $i++; ?>">
              <div class="deskripsi mt10">
                ...
                <?php foreach ($data['indikator'] as $indikator) : ?>
                  <h4 class="mt10 grey">
                    <span class="me-3 grey"><?= $j++; ?>.</span><?= $indikator['deskripsi_indikator']; ?>
                  </h4>
                <?php endforeach; ?>
              </div>
            </div>
