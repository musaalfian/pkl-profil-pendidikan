...
class User extends BaseController
{
    ...
    {
        // dd($jabatan);
        $karyawanDinasJabatan = $this->MJabatan->joinKaryawanJabatan();
        foreach ($karyawanDinasJabatan as $karyawanDinasJabatan) {
            $indikator = $this->MIndikatorKerja->indikatorKerjaJabatan($karyawanDinasJabatan['id_jabatan']);
            $karyawanDinasJabatan['indikator'] = $indikator;
            $kDinasJabatan[] = $karyawanDinasJabatan;
        }
        // dd($karyawanDinasJabatan);
        // dd($kDinasJabatan);
        $data = [
            'title' => 'Tentang | Profil Pendidikan',
            'karyawanJabatan' => $kDinasJabatan
        ];
